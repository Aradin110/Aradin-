...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕ :ARADIN:▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈  |:ARADIN: ▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : ARADIN~IMTIAZ
\033[1;92m☞ WhatsApp   : 03237528063
\033[1;95m☞ YouTube    : ARADIN~CLONING
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCaBSCTs3kfwD3OhU6XC4ZwA')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' CONTECT ON FACEBOOK')
	print (S + '[' + P + '☞3' + S + ']' + S + ' CONTECT ON WHATSAPP')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('')
	    os.system('https://www.facebook.com/profile.php?id=100067945261995')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03237528063✓')
	    psb('WellCome To ARADIN~CLONING')
	    psb('Congratulations  My Tools Is Make Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel 𝐀𝐑𝐀𝐃𝐈𝐍~𝐂𝐋𝐎𝐍𝐄𝐑✓')
